...
export const ChangePinScreen = React.memo(
  ...
  return (
    ...
    >
      ...
      >
        <PinField label="Old pin" value={oldPin} onChangeText={setOldPin} />
        <PinField
          label="New pin"
          value={newPin}
        ...
        <Text style={cp.hint}>
          If changed! This will be set as your new transaction PIN to validate payment
        </Text>
        ...
        >
          <View style={cp.btn}>
            <Text style={cp.btnText}>Change pin</Text>
          </View>
        </Pressable>

        <Pressable style={cp.anotherWayBtn} onPress={() => {}}>
      ...
      >
        <View style={[cp.navBar, { height: NAV_BAR_HEIGHT }]}>
          ...
          <View style={[cp.navContent, { marginTop: insets.top }]}>
            ...
            <Text style={cp.navTitle}>Change Pin</Text>
          </View>
        </View>
      </PanGestureHandler>
    </Animated.View>
